...
import menuicon from './download.png';
...
export function loadModule(smid)
{
   ...
   switch(smid)
   {
        ...
        case "M10102":
            ...
            break;
        case "M00101":
                module.src = "/bookflight";
                titlebar.innerText = "Book Flight";
                break;
        default:
            module.src = "";
            titlebar.innerText = "";
        ...
        return(
            <div className='full-height'>
                <div className='header'>
                    <label style={HS1}>Air Line Reservation System|Air Lines</label>
                ...
                <div className='footer'>
                    Copyright @ Air Lines. All rights reserved.
                </div>
            </div>
        );
    }
