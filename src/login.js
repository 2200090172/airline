...
function Login(){
    ...
    return(
        <div className='full-height'>
            <div id='header' className='loginheader'>Air line reservation system</div>
            ...
            <div id='footer' className='loginfooter'>Copyright @ Air line reservation system. All rights reserved.</div>
        </div>
    );
}
